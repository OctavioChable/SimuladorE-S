...
class colaOperacion: 
    ...
    def encolar(self, datosRecibidos):
        datosXEncolar = [datosRecibidos[0], datosRecibidos[1], datosRecibidos[2], 'En espera', 0]  # Contador de intentos en índice [4]
    ...
    def Automatizado(self, ventana):
        while self.cola:
            ventana.texto_notificaciones.append(f"\nProceso número: {self.procesados + 1}")
            self.procesados += 1
        ...
        # Resumen final después de procesar toda la cola
