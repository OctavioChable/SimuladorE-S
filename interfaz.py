...
class SimuladorEIO(QMainWindow):
    def __init__(self):
        ...
        self.boton_borrarProcesos = QPushButton("Borrar procesos")
        self.boton_borrarProcesos.setEnabled(False)
        self.boton_limpiarSimulador = QPushButton("Limpiar Simulador")
        self.boton_limpiarSimulador.setEnabled(False)
        ...
        self.layout_botones.addWidget(self.boton_borrarProcesos)
        self.layout_botones.addWidget(self.boton_limpiarSimulador)
        ...
        self.tabla.setHorizontalHeaderLabels(["Proceso", "Accion", "Origen", "Estado", "Reintentos", "NumeroOp"])

        self.tabla.setColumnWidth(0, 115)  # Ancho de la columna 0 (en píxeles)
        self.tabla.setColumnWidth(1, 195)  # Ancho de la columna 1
        self.tabla.setColumnWidth(2, 115)  # Ancho de la columna 2
        self.tabla.setColumnWidth(3, 115) 
        self.tabla.setColumnWidth(4, 115) 
        self.tabla.setColumnWidth(5, 115) 
        ...
        # Sección: Procesos Agregados
        self.seccion_procesos_agregados = QWidget()
        self.layout_procesos_agregados = QVBoxLayout()
        self.seccion_procesos_agregados.setLayout(self.layout_procesos_agregados)

        # Título y lista de procesos agregados
        self.layout_procesos_agregados.addWidget(QLabel("Procesos Agregados (Estáticos):"))
        self.lista_procesos_agregados = QListWidget()
        self.layout_procesos_agregados.addWidget(self.lista_procesos_agregados)

        # Agregar la sección "Procesos Agregados" al layout principal
        self.layout_principal.addWidget(self.seccion_procesos_agregados)

        # Sección: Cola Actual
        self.seccion_cola_actual = QWidget()
        self.layout_cola_actual = QVBoxLayout()
        self.seccion_cola_actual.setLayout(self.layout_cola_actual)

        # Título, lista de estado de la cola y tablaCola
        self.layout_cola_actual.addWidget(QLabel("Estado Actual de la Cola:"))
        self.lista_estado_cola = QListWidget()

        self.layout_cola_actual.addWidget(self.tablaCola)

        # Agregar la sección "Cola Actual" al layout principal
        self.layout_principal.addWidget(self.seccion_cola_actual)

        # Sección: Información de Procesos
        self.seccion_informacion_procesos = QWidget()
        self.layout_informacion_procesos = QVBoxLayout()
        self.seccion_informacion_procesos.setLayout(self.layout_informacion_procesos)

        # Título y tabla de información de procesos
        self.layout_informacion_procesos.addWidget(QLabel("Información de Procesos"))
        self.layout_informacion_procesos.addWidget(self.tabla)

        # Agregar la sección "Información de Procesos" al layout principal
        self.layout_principal.addWidget(self.seccion_informacion_procesos)
        ...
        self.boton_limpiarSimulador.clicked.connect(self.LimpiarSimulacion)
        self.boton_borrarProcesos.clicked.connect(self.limpiarProcesos)
    ...
    def iniciar_simulacion(self):
        ...
        self.boton_limpiarSimulador.setEnabled(True)
        self.boton_iniciar.setEnabled(False)
        self.boton_agregar_proceso.setEnabled(False)
    ...
    def LimpiarSimulacion(self):
        self.apagarbotones()
        self.boton_agregar_proceso.setEnabled(True)
        self.procesados = 0
        ...
        self.tablaCola.clearContents()
        self.Procesos = []

    def limpiarProcesos(self):
        self.apagarbotones()
        self.lista_procesos_agregados.clear()
        self.texto_notificaciones.clear()
        self.Procesos = []
    ...
    def agregar_proceso(self):
        ...
        self.boton_borrarProcesos.setEnabled(True)
